export default function WeatherPill({ weather, location, temp, condition, bestTime }) {
    // Support both object-style and individual prop patterns
    const w = weather || (temp != null ? { temp, condition, bestTime } : null);
    if (!w) return null;
